...
function GM:AdminPopulateStockpilesMenu( tbl, cb )
	...
	for k,v in next, tbl do
		...
		CCP.StockpilesMenu.Stockpile[k].DoClick = function( self )
			...
			cb( self.Name, self.Inventory, self.id );
...
function GM:AdminPlayerMenuDisable()
	...
	CCP.AdminMenu.SetSalary:SetValue( 0 );
	CCP.AdminMenu.SetSalaryBut:SetDisabled( true );
	CCP.AdminMenu.SetInterval:SetValue( 0 );
	CCP.AdminMenu.SetIntervalBut:SetDisabled( true );
	...
	CCP.AdminMenu.PlayerFlag:SetValue( "" );
	CCP.AdminMenu.PlayerFlagBut:SetDisabled( true );
	...
	CCP.AdminMenu.EditStock:SetDisabled( true );
	CCP.AdminMenu.WarnName:SetDisabled( true );
	CCP.AdminMenu.ToggleCanFire:SetDisabled( true );
...
function GM:AdminPlayerMenuEnable( ply )
	...
	CCP.AdminMenu.PlayerFlagBut:SetDisabled( false );
	...
	CCP.AdminMenu.PlayerFlag:SetValue( ply:PlayerFlags() );
	CCP.AdminMenu.CombineFlag:SetValue( ply:CombineFlag() );
	
	CCP.AdminMenu.SetSalaryBut:SetDisabled( false );
	CCP.AdminMenu.SetIntervalBut:SetDisabled( false );
	CCP.AdminMenu.SetSalary:SetValue( ply:SalaryAmount() );
	CCP.AdminMenu.SetInterval:SetValue( ply:SalaryInterval() );
	...
	if( GAMEMODE:LookupCombineFlag( ply:ActiveFlag() ) ) then
		...
		CCP.AdminMenu.ToggleCanFire:SetDisabled( false );
		
	end
	
	CCP.AdminMenu.EditInventory:SetDisabled( false );
	CCP.AdminMenu.EditStock:SetDisabled( false );
...
function GM:AdminCreatePlayersMenu()
	...
	CCP.AdminMenu.SetSalaryLabel = vgui.Create( "DLabel", CCP.AdminMenu.ContentPane );
	CCP.AdminMenu.SetSalaryLabel:SetText( "Set Salary" );
	CCP.AdminMenu.SetSalaryLabel:SetPos( 496, 130 );
	CCP.AdminMenu.SetSalaryLabel:SetFont( "CombineControl.LabelMedium" );
	CCP.AdminMenu.SetSalaryLabel:SizeToContents();
	CCP.AdminMenu.SetSalaryLabel:PerformLayout();
	
	CCP.AdminMenu.SetSalary = vgui.Create( "DTextEntry", CCP.AdminMenu.ContentPane );
	CCP.AdminMenu.SetSalary:SetFont( "CombineControl.LabelMedium" );
	CCP.AdminMenu.SetSalary:SetPos( 580, 130 );
	CCP.AdminMenu.SetSalary:SetSize( 40, 20 );
	CCP.AdminMenu.SetSalary:SetNumeric( true );
	CCP.AdminMenu.SetSalary:SetValue( 0 );
	CCP.AdminMenu.SetSalary:PerformLayout();
	
	CCP.AdminMenu.SetSalaryBut = vgui.Create( "DButton", CCP.AdminMenu.ContentPane );
	CCP.AdminMenu.SetSalaryBut:SetFont( "CombineControl.LabelSmall" );
	CCP.AdminMenu.SetSalaryBut:SetText( "Set" );
	CCP.AdminMenu.SetSalaryBut:SetPos( 630, 130 );
	CCP.AdminMenu.SetSalaryBut:SetSize( 100, 20 );
	function CCP.AdminMenu.SetSalaryBut:DoClick()
		
		RunConsoleCommand( "rpa_setsalaryamount", CCP.AdminMenu.PlayerList:GetLine( CCP.AdminMenu.SelectedID ).SteamID, CCP.AdminMenu.SetSalary:GetValue() );
		
	end
	CCP.AdminMenu.SetSalaryBut:SetDisabled( true );
	CCP.AdminMenu.SetSalaryBut:PerformLayout();
	
	CCP.AdminMenu.SetIntervalLabel = vgui.Create( "DLabel", CCP.AdminMenu.ContentPane );
	CCP.AdminMenu.SetIntervalLabel:SetText( "Set Interval" );
	CCP.AdminMenu.SetIntervalLabel:SetPos( 496, 160 );
	CCP.AdminMenu.SetIntervalLabel:SetFont( "CombineControl.LabelMedium" );
	CCP.AdminMenu.SetIntervalLabel:SizeToContents();
	CCP.AdminMenu.SetIntervalLabel:PerformLayout();
	
	CCP.AdminMenu.SetInterval = vgui.Create( "DTextEntry", CCP.AdminMenu.ContentPane );
	CCP.AdminMenu.SetInterval:SetFont( "CombineControl.LabelMedium" );
	CCP.AdminMenu.SetInterval:SetPos( 580, 160 );
	CCP.AdminMenu.SetInterval:SetSize( 40, 20 );
	CCP.AdminMenu.SetInterval:SetNumeric( true );
	CCP.AdminMenu.SetInterval:SetValue( 0 );
	CCP.AdminMenu.SetInterval:PerformLayout();
	
	CCP.AdminMenu.SetIntervalBut = vgui.Create( "DButton", CCP.AdminMenu.ContentPane );
	CCP.AdminMenu.SetIntervalBut:SetFont( "CombineControl.LabelSmall" );
	CCP.AdminMenu.SetIntervalBut:SetText( "Set" );
	CCP.AdminMenu.SetIntervalBut:SetPos( 630, 160 );
	CCP.AdminMenu.SetIntervalBut:SetSize( 100, 20 );
	function CCP.AdminMenu.SetIntervalBut:DoClick()
		
		RunConsoleCommand( "rpa_setsalaryinterval", CCP.AdminMenu.PlayerList:GetLine( CCP.AdminMenu.SelectedID ).SteamID, CCP.AdminMenu.SetInterval:GetValue() );
		
	end
	CCP.AdminMenu.SetIntervalBut:SetDisabled( true );
	CCP.AdminMenu.SetIntervalBut:PerformLayout();
	
	CCP.AdminMenu.CharFlagLabel = vgui.Create( "DLabel", CCP.AdminMenu.ContentPane );
	CCP.AdminMenu.CharFlagLabel:SetText( "Character Flags" );
	...
	CCP.AdminMenu.PlayerFlagLabel = vgui.Create( "DLabel", CCP.AdminMenu.ContentPane );
	CCP.AdminMenu.PlayerFlagLabel:SetText( "Player Flags" );
	CCP.AdminMenu.PlayerFlagLabel:SetPos( 496, 190 );
	CCP.AdminMenu.PlayerFlagLabel:SetFont( "CombineControl.LabelMedium" );
	CCP.AdminMenu.PlayerFlagLabel:SizeToContents();
	CCP.AdminMenu.PlayerFlagLabel:PerformLayout();
	
	CCP.AdminMenu.PlayerFlag = vgui.Create( "DTextEntry", CCP.AdminMenu.ContentPane );
	CCP.AdminMenu.PlayerFlag:SetFont( "CombineControl.LabelMedium" );
	CCP.AdminMenu.PlayerFlag:SetPos( 580, 190 );
	CCP.AdminMenu.PlayerFlag:SetSize( 40, 20 );
	CCP.AdminMenu.PlayerFlag:PerformLayout();
	
	CCP.AdminMenu.PlayerFlagBut = vgui.Create( "DButton", CCP.AdminMenu.ContentPane );
	CCP.AdminMenu.PlayerFlagBut:SetFont( "CombineControl.LabelSmall" );
	CCP.AdminMenu.PlayerFlagBut:SetText( "Apply" );
	CCP.AdminMenu.PlayerFlagBut:SetPos( 630, 190 );
	CCP.AdminMenu.PlayerFlagBut:SetSize( 100, 20 );
	function CCP.AdminMenu.PlayerFlagBut:DoClick()
		
		RunConsoleCommand( "rpa_setflags", CCP.AdminMenu.PlayerList:GetLine( CCP.AdminMenu.SelectedID ).SteamID, CCP.AdminMenu.PlayerFlag:GetValue() );
		
	end
	CCP.AdminMenu.PlayerFlagBut:SetDisabled( true );
	CCP.AdminMenu.PlayerFlagBut:PerformLayout();
	
	CCP.AdminMenu.CombineFlagLabel = vgui.Create( "DLabel", CCP.AdminMenu.ContentPane );
	CCP.AdminMenu.CombineFlagLabel:SetText( "Police Flag" );
	...
	CCP.AdminMenu.ToggleCanFire = vgui.Create( "DButton", CCP.AdminMenu.ContentPane );
	CCP.AdminMenu.ToggleCanFire:SetFont( "CombineControl.LabelSmall" );
	CCP.AdminMenu.ToggleCanFire:SetText( "Disable Weaponry" );
	CCP.AdminMenu.ToggleCanFire:SetPos( 220, 340 );
	CCP.AdminMenu.ToggleCanFire:SetSize( 100, 20 );
	function CCP.AdminMenu.ToggleCanFire:DoClick()
		
		RunConsoleCommand( "rpa_togglecanfire", CCP.AdminMenu.PlayerList:GetLine( CCP.AdminMenu.SelectedID ).SteamID );
		
	end
	CCP.AdminMenu.ToggleCanFire:SetDisabled( true );
	CCP.AdminMenu.ToggleCanFire:PerformLayout();
	...
	CCP.AdminMenu.EditStock = vgui.Create( "DButton", CCP.AdminMenu.ContentPane );
	CCP.AdminMenu.EditStock:SetFont( "CombineControl.LabelSmall" );
	CCP.AdminMenu.EditStock:SetText( "Edit stockpile..." );
	CCP.AdminMenu.EditStock:SetPos( 330, 370 );
	CCP.AdminMenu.EditStock:SetSize( 100, 20 );
	function CCP.AdminMenu.EditStock:DoClick()
		
		net.Start( "nAdminRequestStockpileMenu" );
			net.WriteString( CCP.AdminMenu.PlayerList:GetLine( CCP.AdminMenu.SelectedID ).SteamID );
		net.SendToServer();
		
	end
	CCP.AdminMenu.EditStock:SetDisabled( true );
	CCP.AdminMenu.EditStock:PerformLayout();
	...
	CCP.AdminMenu.WarnName:SetPos( 440, 370 );
...
function GM:AdminCreateLogsMenu()
	...
	CCP.AdminMenu.LogButCombine:SetText( "Police" );
...
function GM:AdminCreateRostersMenu()
	...
	CCP.AdminMenu.RosterCombine:SetText( "ARCS" );
