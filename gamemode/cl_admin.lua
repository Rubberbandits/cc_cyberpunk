...
function nANotGM( len )
	
	GAMEMODE:AddChat( Color( 200, 0, 0, 255 ), "CombineControl.ChatNormal", "You need to be an game master to do this.", { CB_ALL, CB_OOC } );
	
end
net.Receive( "nANotGM", nANotGM );
...
function nASetCombineFlag( len )
	...
	if( LocalPlayer() == ply ) then
		...
		GAMEMODE:AddChat( Color( 229, 201, 98, 255 ), "CombineControl.ChatNormal", "You set " .. targ:RPName() .. "'s police flag to " .. flag .. " (" .. GAMEMODE:FlagPrintName( flag ) .. ").", { CB_ALL, CB_OOC } );
		
	else
		
		GAMEMODE:AddChat( Color( 229, 201, 98, 255 ), "CombineControl.ChatNormal", ply:Nick() .. " set your police flag to " .. flag .. " (" .. GAMEMODE:FlagPrintName( flag ) .. ").", { CB_ALL, CB_OOC } );
...
function nARemoveCombineFlag( len )
	...
	if( LocalPlayer() == ply ) then
		...
		GAMEMODE:AddChat( Color( 229, 201, 98, 255 ), "CombineControl.ChatNormal", "You removed " .. targ:RPName() .. "'s police flag.", { CB_ALL, CB_OOC } );
		
	else
		
		GAMEMODE:AddChat( Color( 229, 201, 98, 255 ), "CombineControl.ChatNormal", ply:Nick() .. " removed your police flag.", { CB_ALL, CB_OOC } );
...
function nASetCombineSquad( len )
	...
	if( LocalPlayer() == ply ) then
		...
		GAMEMODE:AddChat( Color( 229, 201, 98, 255 ), "CombineControl.ChatNormal", "You set " .. targ:RPName() .. "'s police squad to " .. squad .. ".", { CB_ALL, CB_OOC } );
		
	else
		
		GAMEMODE:AddChat( Color( 229, 201, 98, 255 ), "CombineControl.ChatNormal", ply:Nick() .. " set your police squad to " .. squad .. ".", { CB_ALL, CB_OOC } );
...
function nARemoveCombineSquad( len )
	...
	if( LocalPlayer() == ply ) then
		...
		GAMEMODE:AddChat( Color( 229, 201, 98, 255 ), "CombineControl.ChatNormal", "You removed " .. targ:RPName() .. "'s police squad.", { CB_ALL, CB_OOC } );
		
	else
		
		GAMEMODE:AddChat( Color( 229, 201, 98, 255 ), "CombineControl.ChatNormal", ply:Nick() .. " removed your police squad.", { CB_ALL, CB_OOC } );
...
function nASetCombineSquadID( len )
	...
	if( LocalPlayer() == ply ) then
		...
		GAMEMODE:AddChat( Color( 229, 201, 98, 255 ), "CombineControl.ChatNormal", "You set " .. targ:RPName() .. "'s police squad ID to " .. squadid .. ".", { CB_ALL, CB_OOC } );
		
	else
		
		GAMEMODE:AddChat( Color( 229, 201, 98, 255 ), "CombineControl.ChatNormal", ply:Nick() .. " set your police squad ID to " .. squadid .. ".", { CB_ALL, CB_OOC } );
...
function nACombineRoster( len )
	...
	chat.OldAddText( Color( 128, 128, 128, 255 ), "ARCS ROSTER:" );
...
function nANoCombineRoster( len )
	...
	chat.OldAddText( Color( 128, 128, 128, 255 ), "COULD NOT RETRIEVE ARCS ROSTER." );
