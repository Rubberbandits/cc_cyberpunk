...
util.AddNetworkString( "nChangeTitleOne" );
util.AddNetworkString( "nChangeTitleTwo" );
...
util.AddNetworkString( "nChatPDAGlobal" );
util.AddNetworkString( "nChatPDAPrivate" );
util.AddNetworkString( "nChatRadioSurround" );
util.AddNetworkString( "nChatBigRadio" );
util.AddNetworkString( "nChatDispatch" );
...
util.AddNetworkString( "nChatSalaryReceived" );
...
util.AddNetworkString( "nANoSecondTargetFound" );
...
util.AddNetworkString( "nSetSquadOffline" );
util.AddNetworkString( "nSetSquadID" );
util.AddNetworkString( "nSetSquadIDOffline" );
...
util.AddNetworkString( "nRequestCallsign" );
...
util.AddNetworkString( "nLoadStockpile" );
util.AddNetworkString( "nLoadAugments" );
...
util.AddNetworkString( "nReceiveAugments" );
util.AddNetworkString( "nRequestAugments" );
...
util.AddNetworkString( "nRequestStockpileName" );
util.AddNetworkString( "nRequestStockpiles" );
util.AddNetworkString( "nRequestMoveStockpiles" );
util.AddNetworkString( "nTakeFromStockpile" );
util.AddNetworkString( "nMoveToStockpile" );
util.AddNetworkString( "nAdminRequestStockpileMenu" );
util.AddNetworkString( "nAdminPopulateTakeAccessMenu" );
util.AddNetworkString( "nAdminPopulateGiveAccessMenu" );
util.AddNetworkString( "nAdminRemoveStockpile" );
util.AddNetworkString( "nSetupStockpile" );
util.AddNetworkString( "nPopulateStockpilesMenu" );
util.AddNetworkString( "nAdminPopulateStockpilesMenu" );
util.AddNetworkString( "nPopulateMoveToStock" );
util.AddNetworkString( "nPopulateStockpilesMenu" );
util.AddNetworkString( "nOpenStockpilesMenu" );
util.AddNetworkString( "nStockpileNameTaken" );
util.AddNetworkString( "nARemovedStockpileSuccess" );